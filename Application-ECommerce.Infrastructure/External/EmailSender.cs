...
namespace Application_ECommerce.Infrastructure.External
{
        ...
        public async Task SendEmailAsync(EmailMessage emailMessage)
        {
            try
            {
                ...
                using (var client = new SmtpClient())
                {
                    ...
                    await client.ConnectAsync(_emailSettings.SmptpServer, _emailSettings.SmtpPort, SecureSocketOptions.StartTls);
